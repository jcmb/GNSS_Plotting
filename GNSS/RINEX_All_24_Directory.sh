...
do
   BASE_NAME=${f%%.*}
#   echo $BASE_NAME
   if [ ! -e $GNSS_24_BASE_DIR/$2/$5/$4/$BASE_NAME.zip ]
   then
       /usr/local/bin/t0xConvert -o -z $f
#echo       mv $BASE_NAME.zip $GNSS_24_BASE_DIR/$2/$3/$5/ >/dev/null
       mv $BASE_NAME.zip $GNSS_24_BASE_DIR/$2/$5/$4/ >/dev/null
#       if [ $1 == T04 ]
#       then
#	   BASE=`basename $f .$1`
